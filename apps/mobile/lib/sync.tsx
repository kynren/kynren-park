...
export interface Restaurant { id: string; slug: string; name: string; cuisine?: string | null; description?: string | null; openingHours?: string | null; heroImage?: string | null; images?: string[]; menuItems: MenuItem[]; poiId?: string | null; clickCollect?: boolean; }
